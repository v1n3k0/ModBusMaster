...
public class Registro {
    ...
    public boolean escreverUnicoRegistro(TCPMasterConnection con, int ref, int valor){
    ...
    public boolean escreverMultiplosRegistros(TCPMasterConnection con, int ref, int[] valores){
            /* Variáveis ​​para armazenar os parâmetros 
            ref = A referência; Desloca onde começar a ler*/
    ...
    public int[] lerMultiplosRegistros(TCPMasterConnection con, int ref, int count){
            /* Variáveis ​​para armazenar os parâmetros 
            ref = A referência; Desloca onde começar a ler
